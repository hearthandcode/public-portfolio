...
| --- | --- | --- | --- | --- |
| Knowledge architecture | `01-knowledge-governance/artifacts/knowledge-taxonomy.yaml`, `taxonomy-integrity-rules.yaml`, and `ai-ready-knowledge-architecture.md` | Independent knowledge-system design work plus a taxonomy registry and integrity rules | Public-safe derivatives | Internal paths, personal-record references, contributor identities, employer-specific application context, and runtime details are omitted. Pilot artifacts and a design record, not a complete ontology or deployed product. |
